...

{
  ...
  "jd_draft": {
    ...
    "about_the_role": "<2-3 paragraphs. Written for an external candidate. Ground this in the HM's day-to-day description ('${hmAnswers.day_to_day ?? ""}') as your primary source of truth for what this person actually does — but write it in polished, compelling JD language that synthesizes the full picture from HM answers and stakeholder input. Do not copy the HM's words directly.>",

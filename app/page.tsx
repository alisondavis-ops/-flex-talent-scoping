...
const styles = {
  page: { minHeight: "100vh", background: "#1D1D1D", color: "#F7F7F7", fontFamily: "'DM Sans', system-ui, sans-serif", display: "flex", alignItems: "center", justifyContent: "center" },
  container: { maxWidth: 560, padding: "40px 24px", textAlign: "center" as const },
  label: { fontSize: 11, fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "#8B5DD4", marginBottom: 20, display: "block" },
  heading: { fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 42, color: "#F7F7F7", lineHeight: 1.2, marginBottom: 16 },
  sub: { fontSize: 16, color: "#787878", lineHeight: 1.6, marginBottom: 40 },
  ...
  btnSecondary: { display: "inline-block", padding: "14px 24px", borderRadius: 10, border: "1px solid #3A3A3A", background: "transparent", color: "#CACACA", fontSize: 15, fontFamily: "inherit", textDecoration: "none", marginBottom: 12 },
};
